    ...
    java.util.concurrent,
        ...
        CopyOnWriteArrayList, CopyOnWriteArraySet and CocurrentHashMap
            ...
            ConcurrentMap
                ...
                It is just like HashTable, but provides better synchronization. If you see HashTable, methods are synchronized. If you see ConcurrentHashMap, pieces of code are synchronized.
